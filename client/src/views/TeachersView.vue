        ...
        <form class="form-row" @submit.prevent="page.list">
            <div class="row g-3">
                ...
                <div class="col-sm-6 col-md-4">
                    ...
                    <input type="text" name="s-cpf" class="form-control" id="s-cpf"
                ...
                <div class="col-sm-12 col-md-4">
                    ...
                    :class="{ 'form-control-alert': pgdata.rules.valids.qualification }" id="s-qualification"
...
<div v-if="pgdata.uiview.register" class="box p-5 mb-3">
    ...
    <form class="form-row" @submit.prevent="page.save">
        ...
        <div class="col-sm-12 col-md-4">
            ...
            :class="{ 'form-control-alert': pgdata.rules.valids.name }" id="name" placeholder="Nome Completo do Professor (a)"
