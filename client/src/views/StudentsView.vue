...
<template>
    <div class="modal fade" id="modalImportStudents" tabindex="-1" aria-labelledby="modalImportStudentsLabel" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content p-4">
                ...
                <div class="modal-footer border-0">
                    <button type="button" class="btn btn-form btn-danger d-flex align-items-center" data-bs-dismiss="modal">
    ...
    <div class="container-main position-relative">
        ...
        <main class="container main-view px-3">
            ...
            <header class="d-flex align-items-center justify-content-between my-4">
                ...
                <div class="page-actions d-flex align-items-center">
                    ...
                    <button type="button" class="btn btn-action d-flex align-items-center ms-2" data-bs-toggle="modal" data-bs-target="#modalImportStudents">
                ...
                <form class="form-row" @submit.prevent="page.list">
                    <div class="row g-3">
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            placeholder="000.000.000-00" v-model="pgdata.search.cpf" v-maska:[masks.maskcpf]>
                        </div>
                        <div class="col-sm-12 col-md-4">
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <input type="text" name="birth" class="form-control" id="s-birth"
                            placeholder="DD/MM/AAAA" v-model="pgdata.search.birth">
                        </div>
                        <div class="col-sm-12 col-md-4">
        ...
        <div v-if="!pgdata.uiview.register" class="box p-5 mb-3">
            <HeaderBoxUiComp 
            icon="keypad-outline" title="Lista de Alunos Registrados"
        ...
        <div v-if="pgdata.uiview.register" class="box p-5 mb-3">
            <HeaderBoxUiComp 
            icon="people-outline" title="Registro de Alunos"
            ...
            <form class="form-row" @submit.prevent="page.save">
                ...
                <div class="col-sm-12 col-md-4">
                    ...
                    <select name="races" class="form-control" id="races"
                    v-model="pgdata.data.race">
                    <option></option>
                    <option v-for="s in pgdata.selects.races" :key="s.id" :value="s.id">{{ s.title }}</option>
                </select>
            </div>
            <div class="col-sm-12 col-md-4">
                <label for="sex" class="form-label">Sexo</label>
                <select name="sex" class="form-control" id="sex"
                v-model="pgdata.data.sex">
                <option></option>
                <option v-for="s in pgdata.selects.sexs" :key="s.id" :value="s.id">{{ s.title }}</option>
                </select>
            </div>
        <div class="col-sm-12 col-md-4">
            <label for="sige" class="form-label">ID. Sige</label>
            <input type="text" name="sige" class="form-control" id="sige"
            :class="{ 'form-control-alert': pgdata.rules.valids.sige }"
            placeholder="0000000000000" v-model="pgdata.data.sige">
        </div>
        <div class="col-sm-12 col-md-4">
            <label for="censo" class="form-label">ID. Censo</label>
            <input type="text" name="censo" class="form-control" id="censo"
            placeholder="0000000000000" v-model="pgdata.data.censo">
        </div>
        <div class="col-sm-12 col-md-4">
            <label for="cpf" class="form-label">CPF</label>
            <input type="text" name="cpf" class="form-control" id="cpf"
            placeholder="000.000.000-00" v-model="pgdata.data.cpf" v-maska:[masks.maskcpf]>
        </div>
        <div class="col-sm-12 col-md-4">
            <label for="nis" class="form-label">NIS</label>
            <input type="text" name="nis" class="form-control" id="nis"
            placeholder="0000000000000" v-model="pgdata.data.nis" v-maska:[masks.masknis]>
        </div>
        <div class="col-sm-12 col-md-8">
        ...
        <div class="col-sm-12 col-md-4">
            ...
            v-model="pgdata.data.city">
        </div>
        <div class="col-sm-12 col-md-4">
            <label for="cep" class="form-label">CEP</label>
            <input type="text" name="cep" class="form-control" id="cep"
            placeholder="00000-000" v-model="pgdata.data.cep" v-maska:[masks.maskcep]>
        </div>
        <div class="col-sm-12">
